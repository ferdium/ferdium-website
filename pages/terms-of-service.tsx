    ...
    <Layout>
      ...
      <Section>
        <div>
          ...
          <p>
            <strong>Last Updated 07 May 2022</strong>
          </p>
          ...
          <p>
            ...
            <strong>Ferdium</strong>, doing business as
            <strong> Ferdium</strong> <strong>(https://ferdium.org) </strong>website as well as any
            related applications (the <strong>Site</strong>). &nbsp;
          </p>
          <p>
            The Site provides the following services: Inform you about the Ferdium desktop
            application. You agree that by accessing the Site and/or Services, you have read,
          ...
          <p>
            1.3 We may make changes to these Terms and Conditions at any time. The updated version
            of these Terms and Conditions will be indicated by an updated revised date and the
            updated version will be effective as soon as it is accessible. You are responsible for
            reviewing these Terms and Conditions to stay informed of updates. Your continued use of
          ...
          <p>
            1.5 Our site is directed to people residing in Europe. The information provided on the
          ...
          <p>
            <strong>&mdash; </strong>Our Privacy Notice https://ferdium.org/privacy-policy, which
            sets out the terms on which we process any personal data we collect from you, or that
            you provide to us. By using the Site, you consent to such processing and you warrant
          ...
          <p>
            ...
            the site and our services available. The Site may not be used in connection with any
          ...
          <p>
            <strong>&mdash; </strong>Falsely imply a relationship with us or another company with
          ...
          <p>
            ...
            true, accurate, current, and complete and relate to you and not a third party; (b) you
          ...
          <p>
            ...
            incomplete, we may suspend or terminate your account. We may remove or change a user
          ...
          <p>
            ...
            us (<strong>User Content</strong>). You understand and agree that your User Content may
            be viewed by other users on the Site, and that they may be able to see who has posted
            that User Content.
          </p>
          <p>
            4.2
            <em>
              You further agree that we can use your User Content for any other purposes whatsoever
              in perpetuity without payment to you, and combine your User Content with other content
              for use within the Site and otherwise. We do not have to attribute your User Content
              to you
            </em>
            .{" "}
            <em>
              When you upload or post content to our site, you grant us the following rights to use
              that content:
            </em>
            &nbsp;
          </p>
          ...
          <p>
            ...
            you will be liable to us and indemnify us for any breach of that warranty. This means
          ...
          <p>
            ...
            such content that contains incorrect information or is defamatory or loss of User
            Content. We accept no obligation to screen, edit or monitor any User Content but we
            reserve the right to remove, screen and/or edit any User Content without notice and at
            any time. User Content has not been verified or approved by us and the views expressed
          ...
          <p>
            ...
            on the Site (<strong>Our Content</strong>) are owned or licensed to us, and are
          ...
          <p>
            ...
            Services or Our Content may be copied, reproduced, aggregated, republished, uploaded,
          ...
          <p>
            ...
            the Site or Our Content, including the modification of the paper or digital copies you
            may have downloaded.
          </p>
          <p>
            5.5 We shall (a) prepare the Site and Our Content with reasonable skill and care; and
            (b) use industry standard virus detection software to try to block the uploading of
          ...
          <p>
            ...
            to amount to advice on which you should rely. You must obtain professional or specialist
            advice before taking, or refraining from taking, any action on the basis of the content
            on the Site. &nbsp;
          </p>
          <p>
            5.7 Although we make reasonable efforts to update the information on our site, we make
            no representations, warranties or guarantees, whether express or implied, that Our
          ...
          <p>
            ...
            do not have any influence or control over any such third party websites or applications
            or the third party operator. We are not responsible for and do not endorse any third
          ...
          <p>
            ...
            Contributions; (4) remove from the Site or otherwise disable all files and content that
            are excessive in size or are in any way a burden to our systems; and (5) otherwise
          ...
          <p>
            ...
            experience hardware, software, or other problems or need to perform maintenance related
            to the Site, resulting in interruptions, delays, or errors. You agree that we have no
          ...
          <p>
            ...
            that your use of the Site and/or Services will be at your sole risk except as expressly
            set out in these Terms and Conditions. All warranties, terms, conditions and
            undertakings, express or implied (including by statute, custom or usage, a course of
            dealing, or common law) in connection with the Site and Services and your use thereof
            including, without limitation, the implied warranties of satisfactory quality, fitness
            for a particular purpose and non-infringement are excluded to the fullest extent
            permitted by applicable law. &nbsp;
          </p>
          <p>
            We make no warranties or representations about the accuracy or completeness of the
            Site&acirc;&euro;&trade;s content and are not liable for any (1) errors or omissions in
            ...
            interruption or cessation of transmission to or from the site or services; and/or (4)
            any bugs, viruses, trojan horses, or the like which may be transmitted to or through the
            site by any third party. We will not be responsible for any delay or failure to comply
            with our obligations under these Terms and Conditions if such delay or failure is caused
          ...
          <p>
            <strong>&mdash; </strong>We do not exclude or limit in any way our liability to you
            where it would be unlawful to do so. This includes liability for death or personal
          ...
          <p>
            <strong>&mdash; </strong>Please note that we only provide our Site for domestic and
            private use. You agree not to use our Site for any commercial or business purposes, and
            we have no liability to you for any loss of profit, loss of business, business
            interruption, or loss of business opportunity.
          </p>
          <p>
            <strong>&mdash; </strong>If defective digital content that we have supplied, damages a
            device or digital content belonging to you and this is caused by our failure to use
            reasonable care and skill, we will either repair the damage or pay you compensation.
          </p>
          <p>
            <strong>&mdash; </strong>You have legal rights in relation to goods that are faulty or
          ...
          <p>
            ...
            of the Site and the Services (including blocking certain IP addresses), to any person
            for any reason including without limitation for breach of any representation, warranty
            or covenant contained in these Terms and Conditions or of any applicable law or
            regulation. &nbsp;
          </p>
          <p>
            If we determine, in our sole discretion, that your use of the Site/Services is in breach
            of these Terms and Conditions or of any applicable law or regulation, we may terminate
          ...
          <p>
            11.2 These Terms and Conditions and any policies or operating rules posted by us on the
          ...
          <p>
            ...
            <em>
              ...
              formation, are governed by English law. You and we both agree that the courts of
              England and Wales will have exclusive jurisdiction expect that if you are a resident
              of Northern Ireland you may also bring proceedings in Northern Ireland, and if you are
              resident of Scotland, you may also bring proceedings in Scotland. If you have any
              complaint or wish to raise a dispute under these Terms and Conditions or otherwise in
          ...
          <p>
            ...
            <em>
              - If you are a business user, these Terms and Conditions, their subject matter and
          ...
          <p>
            11.10 A person who is not a party to these Terms and Conditions shall have no right
